      ...
      <div className="about-container" id="about">
        ...
        <div className="about-content">
          <div className="profile">
            <img src="./profile.jpeg" alt="Profile Photo" id="profileonly"/>
            <div className="icon-section">
              <img src="./tata2.png" alt="Tata Motors" title="Tata Motors" style={{height:'45px',  padding:'3px'}}/>
              <img src="./honda2.png" alt="Honda Motor" title="Honda Motor"/>
              <img src="./3M2.png" alt="3M India" title="3M India"/>
            </div>
          </div>
